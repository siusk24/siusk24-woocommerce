                    ...
                    if (current_shipping_method_layout &&
                        ...
                        if (typeof siusk_terminal_select !== 'undefined') {
                            ...
                            if (newElement && !document.getElementById('siusk24_generated_wrapper')) {
                                ...
                                wrapper.insertAdjacentHTML('beforeend', '<div id="siusk24_map_container"></div><input type="hidden" name="siusk24_terminal"/>');
                                ...
                                if (typeof jQuery !== 'undefined' && jQuery.fn.select2) {
                                    ...
                                    jQuery(document).on('change', "select[name='siusk24_terminal']", function() {
                            ...
                            if (newElement && !document.getElementById('siusk24_generated_wrapper')) {
                                ...
                                if (typeof jQuery !== 'undefined' && jQuery.fn.select2) {
                                    ...
                                    if( '' !== siusk_terminal_previously_selected_description ) {
                                        ...
                                        jQuery("select[name='siusk24_terminal']").each(function (i, select) {
...
function loadSiusk24MappingBlock() {
    ...
    tmjs
        .sub('terminal-selected', function (data) {
