...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Siusk24Mapping", function() { return Siusk24Mapping; });
...
var Siusk24Mapping = /*#__PURE__*/function () {
  function Siusk24Mapping(api_server_url) {
    var _this = this;

    _classCallCheck(this, Siusk24Mapping);
  ...
  return Siusk24Mapping;
}();
window.Siusk24Mapping = Siusk24Mapping;
...
var DOMManipulator = /*#__PURE__*/function () {
  ...
  _createClass(DOMManipulator, [{
    ...
    value: function addContainer(id, strings) {
      ...
      jQuery(`#siusk24_map_container`).append(container);
    ...
    value: function addModal(id, strings) {
      ...
      var modal = this.createElement('div', {
        classList: [this.isModal ? 'tmjs-modal siusk24' : 'tmjs-modal-flat', this.isModal ? 'tmjs-hidden' : ''],
        innerHTML: template
      });
      modal.id = id;
    ...
    value: function handleTerminalListEvents(event, data) {
      ...
      if (event.target.classList.contains('tmjs-select-btn')) {
        ...
        jQuery.ajax({
          ...
          url: siusk24_front_controller_url,
          cache: false,
          dataType: 'json',
                  ...
                  jQuery.fancybox.open([
                      {
                          ...
                          autoScale: true,
                          minHeight: 30,
                          content: '<p class="fancybox-error">' + siusk24lt_parcel_terminal_error + '</p>'
                      }],
                      {
                          padding: 0
                      }
                      ...
                      alert(siusk24lt_parcel_terminal_error);
              }
          }
      });*/
    ...
    value: function renderTerminalList(terminals) {
      ...
      terminals.forEach(function (loc) {
        ...
        var template = "<span class=\"tmjs-terminal-name\">".concat(name).concat(loc.address);
